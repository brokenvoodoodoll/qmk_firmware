...
LAYOUT(
    ...
    KC_NO,   KC_PAST, KC_P4,   KC_P5,   KC_P6,   KC_PPLS,                     MS_BTN4, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, KC_NO,
    KC_TRNS, KC_PDOT, KC_P1,   KC_P2,   KC_P3,   KC_P0,     KC_NO,   KC_NO,   KC_NO,   KC_BSPC, KC_NO,   KC_DEL,  KC_NO,   KC_NO,
                      KC_TRNS, KC_TRNS, KC_TRNS, MO(MEDIA), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
),
LAYOUT(
    ...
    KC_TRNS, KC_NO, KC_NO,   S(KC_7), S(KC_2),    S(KC_3), KC_NO,   KC_NO,   S(KC_LBRC), S(KC_RBRC), S(KC_COMM), S(KC_DOT),  KC_SLSH,    KC_BSLS,
