...
#define TAB_LT2 LT(MEDIA, KC_TAB)
...
const uint16_t PROGMEM combo_cg_togg[] = {KC_A, KC_G, COMBO_END};
const uint16_t PROGMEM combo_caps_word[] = {KC_Q, KC_T, COMBO_END};
combo_t key_combos[] = {
...
LAYOUT(
    ...
    KC_DEL, KC_Z, KC_X,    KC_C,    KC_V,    KC_B,   MCTL_LEFT, MCTL_RGHT, KC_N,    KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_RBRC,
                  KC_LCTL, KC_LALT, KC_LGUI, TAB_LT, SPC_SFT,   ENT_SFT,   BSPC_LT, KC_RGUI, KC_LALT, KC_RCTL
),
LAYOUT(
    KC_TRNS, KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,                     KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
    KC_TRNS, KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,                     MS_BTN5, KC_HOME, KC_UP,   KC_END,  KC_NO,   KC_NO,
    ...
    KC_TRNS, KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_TRNS, KC_TRNS, KC_NO,   KC_PGDN, KC_INS,  KC_PGUP, KC_BSLS, KC_NO,
                    KC_TRNS, KC_TRNS, KC_TRNS, TAB_LT2, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
),
LAYOUT(
    KC_TRNS, KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,                     KC_NO,    KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
    KC_TRNS, KC_F1, KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_NO,    KC_7,    KC_8,    KC_9,    KC_NO,   KC_NO,
    KC_TRNS, KC_F6, KC_F7,   KC_F8,   KC_F9,   KC_F10,                    KC_NO,    KC_4,    KC_5,    KC_6,    KC_NO,   KC_GRV,
    KC_DEL,  KC_NO, KC_NO,   KC_NO,   KC_F11,  KC_F12,  KC_TRNS, KC_TRNS, KC_0,     KC_1,    KC_2,    KC_3,    KC_BSLS, KC_NO,
